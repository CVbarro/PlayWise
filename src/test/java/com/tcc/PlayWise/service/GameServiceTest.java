...
class GameServiceTest {
    ...
    void deveProcessarJogoPago() {
        ...
        game.setStore(Store.STEAM); // ← necessário para aplicar taxa de 30%
        ...
        assertAll("Validação do Game processado",
                ...
                () -> assertEquals("R$ 77,34", processed.getPrice()),
    ...
    void deveProcessarJogoGratuito() {
        ...
        game.setStore(Store.STEAM); // opcional, já que é gratuito
        Game processed = gameService.processGame(game);
        ...
        assertAll("Validação de jogo gratuito",
                ...
                () -> assertEquals("Indisponível", processed.getPrice()),
                () -> assertEquals(-1.0, processed.getPriceOriginal()),
                () -> assertEquals(-1.0, processed.getPriceParsed()),
